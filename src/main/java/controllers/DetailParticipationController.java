...
public class DetailParticipationController implements Initializable {
    ...
    private void gererPart(MouseEvent event) {
        ...
        controllers.GererParticipationController HomeScene = loader.getController();
        ...
        controllers.GererParticipationController GererParticipationController = loader.getController();
    ...
    private void supprimerPart(MouseEvent event) {
        ...
        if (now.isAfter(dateLimite)) {
            ...
            try {
                ...
                Logger.getLogger(controllers.AfficherEvenementsController.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
