...
public class UserOeuvre implements Initializable {
    ...
    void Ajout(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(getClass().getResource("/views/AjouterOeuvre.fxml"));
    ...
    public void start(Stage stage) {
        try {
            ...
            Parent root = FXMLLoader.load(getClass().getResource("/views/UserOeuvre.fxml"));
    ...
    private List<Oeuvre> getData() {
        ...
        Oeuvre ouev;
        try {
            for (Oeuvre item : sp.selectMYAll()) {
...
@FXML
    public void initialize(URL url, ResourceBundle resourceBundle) {
        name_user.setText(MainFx.Userconnected.getUser_name());
