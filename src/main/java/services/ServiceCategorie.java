...
public class ServiceCategorie implements CRUD_oeuvre<Categorie> {
    ...
    @Override
    public List<Categorie> selectMYAll() throws SQLException {
        return null;
    }
    ...
    @Override
    public List<Categorie> selectByname(String ch) throws SQLException {
        return null;
    }
    ...
    @Override
    public List<Categorie> selectAllOeuvre() throws SQLException {
        return null;
    }
    ...
    @Override
    public List<Categorie> trie() throws SQLException {
        return null;
    }
