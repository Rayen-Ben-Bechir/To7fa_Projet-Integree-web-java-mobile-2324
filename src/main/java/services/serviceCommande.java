...
public class serviceCommande implements CRUDCommande<commande> {
    ...
    public void insertOne(commande com) throws SQLException {
        ...
        String req = "INSERT INTO commande(prix_commande, name_commande, date_commande, paiement,id_oeuvre,id_user) VALUES (?, ?, NOW(), ?,?,?)";
    ...
    public void deleteOne(int personId) throws SQLException {
        String req = "DELETE FROM commande WHERE id_commande  = ? and id_user = ?";
